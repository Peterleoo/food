...
export const translations: Translations = {
  ...
  eaten: { zh: '喜欢', en: 'Liked' },
  rejected: { zh: '不喜欢', en: 'Disliked' },
  ...
  aiFallbackTitle: { zh: 'AI 生成未成功', en: 'AI generation did not complete' },
  aiFallbackDesc: { zh: '已先使用本地餐单生成，建议稍后重试或检查 AI 设置。', en: 'A local meal plan was used instead. Try again later or check AI settings.' },
  ...
  customDesc: { zh: '添加自己的食谱。', en: 'Add your own recipes.' },
  searchRecipe: { zh: '搜索食谱', en: 'Search recipes' },
  searchRecipePlaceholder: { zh: '搜索食谱名或食材', en: 'Search by title or ingredient' },
  noSearchResults: { zh: '没有找到匹配的食谱', en: 'No matching recipes found' },
  ...
  mealsEaten: { zh: '喜欢的菜', en: 'Liked Dishes' },
  mealsRejected: { zh: '不喜欢的菜', en: 'Disliked Dishes' },
  acceptanceRate: { zh: '喜好反馈', en: 'Preference Feedback' },
  partial: { zh: '一般', en: 'Neutral' },
  aiAnalysis: { zh: 'AI 分析', en: 'AI Analysis' },
  shoppingList: { zh: '买菜清单', en: 'Shopping List' },
  shoppingListDesc: { zh: '根据餐单和人数估算', en: 'Estimated from meals and servings' },
  noShoppingList: { zh: '今日还没有餐单，生成餐单后会自动汇总。', en: "No meals today yet. Generate today's plan to summarize ingredients." },
  copyList: { zh: '复制清单', en: 'Copy list' },
  copied: { zh: '已复制', en: 'Copied' },
  refreshEstimate: { zh: '重新估算', en: 'Recalculate' },
  relatedDishes: { zh: '相关菜品', en: 'Dishes' },
  ...
  bottomNavSettings: { zh: '底部导航', en: 'Bottom Navigation' },
  bottomNavOrderDesc: { zh: '调整底部按钮的显示顺序。', en: 'Adjust the order of bottom navigation buttons.' },
  moveUp: { zh: '上移', en: 'Move up' },
  moveDown: { zh: '下移', en: 'Move down' },
  resetNavOrder: { zh: '恢复默认顺序', en: 'Reset default order' },
  ...
  exportData: { zh: '导出本地数据', en: 'Export Local Data' },
  importData: { zh: '导入本地数据', en: 'Import Local Data' },
  exportDataDesc: { zh: '导出自定义食谱、饮食记录和本机设置。', en: 'Export custom recipes, meal history, and local settings.' },
  importDataDesc: { zh: '从备份文件恢复数据，会覆盖当前本地数据。', en: 'Restore from a backup file. Current local data will be replaced.' },
  dataExported: { zh: '数据已导出', en: 'Data exported' },
  dataImported: { zh: '数据已导入', en: 'Data imported' },
  importDataConfirm: { zh: '导入会覆盖当前本地数据，确定继续吗？', en: 'Importing will replace current local data. Continue?' },
  importDataFailed: { zh: '导入失败，请确认文件格式正确。', en: 'Import failed. Please check the file format.' },
